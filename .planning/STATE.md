...
Status: Complete
Last activity: 2026-04-09 — Added `/fars` visible-count pills and refactored live refresh to single-pass data fetching with sanitized public feeds; verified 50 passing tests
